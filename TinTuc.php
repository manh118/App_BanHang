...
<!--	margin-top:75.41px;-->
  ...
  <div class="container-fluid">
	...
	<section class="MyContent">
		<div class="DNTK">
			<div class="text-content">
				<i class="text1">Trang chủ / <i style="color: #E5C18C">Tất cả tin tức</i></i>
				<h4 class="text2">TẤT CẢ TIN TỨC</h4>
			</div>
			</div>
	...
	mysqli_select_db($conn,"web") or die ("Không tìm thấy CSDL");// Tìm CSDL đề làm việc
		...
		while($row_tt= mysqli_fetch_array($query_tintuc)){
			
		?>
					<div class="col-4">
						<div class="body_2">
						<div class="box1"> 
						<img width="372px" height="350px" src="img/<?php echo $row_tt['img']?>" >
						<div class="box2">
						<div class="box2_item">
								<span class="day" >18</span>
								<span class="month">08/21</span>
							</div>
						</div>
						</div>
<!--					<img style="font-size: 300px" src="img/t1.webp" alt="" >-->
					<b><?php echo $row_tt['tieu_de']?></b>
					<p class="body-text"><?php echo $row_tt['tin_tuc']?></p>
...
<!--
					...
					<img style="font-size: 300px" src="img/t1.webp" alt="" >
					<b>Khí chất bao nhiêu hạnh phúc bấy nhiêu</b>
					<p class="body-text">Hãy sống như một trái dứa: Đầu đội vương miện, dáng đứng hiên ngang – Bên ngoài gai góc, bên trong ngọt ngào.” Cũng giống như trái dứa, k...</p>
