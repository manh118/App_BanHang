	...
	<section class="MyContent">
		<div class="DNTK">
			<div class="text-content">
				<i class="text1">Trang chủ / <i style="color: #E5C18C">Liên hệ</i></i>
				<h4 class="text2">LIÊN HỆ</h4>
			</div>
			</div>
			...
			<script>
				...
				<div class="body_1">
					<div class="row">
						<div class="col-6">
							<div class="body_1_img">
								<img width="565px" height="536px" src="img/1.png" alt="">
							</div>
						
						</div>
						<div class="col-6">
							<div class="body_1_text">
				  ...
				  <div class="mb-3" style="margin-top: 20px">
					 <label for="validationCustom01" class="form-label"><b>Họ và tên</b></label>
					 <input type="text" class="form-control" id="validationCustom01" placeholder="Nhập Họ" required name="hovaten">
					<div class="valid-feedback"></div>
				  </div>
				 
				<div class="mb-3" style="margin-top: 20px">
					 <label for="validationCustom03" class="form-label"><b>Số Điện Thoại</b></label>
					 <input type="text" class="form-control" id="validationCustom03" placeholder="Nhập Số điện thoại" required name="dienthoai">
					<div class="valid-feedback"></div>
				  </div>
				<div class="mb-3" style="margin-top: 20px">
					 <label for="validationCustom04" class="form-label"><b>Email</b></label>
					 <input type="text" class="form-control" id="validationCustom04" placeholder="Nhập Email" required name="email">
					<div class="valid-feedback"></div>
				  </div>
				<div class="mb-3" style="margin-top: 20px">
					 <label for="validationCustom05" class="form-label"><b>Nội Dung</b></label>
					 <input type="text" class="form-control" id="validationCustom05" placeholder="Nhập Mật khẩu" required name="noidung">
					<div class="valid-feedback"></div>
				  </div>
				 
				  <input type="submit" name="dangky" style="background-color: #9C8350;color: #FFFFFF;width: 100%;margin-top: 20px;height: 60px;border-radius: 30px;" value="GỬI LIÊN HỆ NGAY">
			</form>
<?php
		...
		$diachi = $_POST['noidung'];

		$sqlkh ="INSERT INTO `khachhang` (`id_khach`, `ho_ten`, `sdt`, `email`, `noidung`)VALUES ('Null', '$tenkhachhang', '$dienthoai', '$email', '$diachi')";

		$sql_dangky = mysqli_query($conn, $sqlkh);
...
?>
	...
	<section class="MyFooter bg-dark text-white py-4" style="margin-top: 50px">
		<div class="container">
			<div class="row">
