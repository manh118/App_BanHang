		...
		<div class="row">		
			...
			<div class="col-md-4 py-2 ">
				<div class="input-group mb-1 ">
 					<input type="text" class="form-control" placeholder="Tìm kiếm sản phẩm" aria-label="Recipient's username" aria-	describedby="basic-addon2" style="font-style: italic; opacity: 0.5" >
...
<div class="MyMainmenu" style="background-color: aliceblue;position: relative " >
<!--	margin-top:75.41px;-->
	<div class="container" >
		<div class="row">
			<div class="col-7">					
...
<!--
				...
				<a  style=" margin-left: 10px; line-height: 40px;color: aliceblue">Danh mục sản phẩm</a>
				<ul class="drop" type="none">
					<li><a href="" ></a>sss</li>
					<li><a href=""></a>sssss</li>
					<li><a href=""></a></li>
				</ul>
-->
			</div>
	...
	<div class="MyContent">
		<div class="DNTK">
			<div class="text-content">
				<i class="text1">Trang chủ / <i style="color: #E5C18C">Đăng ký tài khoản</i></i>
				<h4 class="text2">ĐĂNG KÝ TÀI KHOẢN</h4>
			</div>
		...
		<div class="Bang1">
			<div class="row">
				<div class="col">
					<div class="BangDN"><a href="DangNhap.php" style="color: #000000">Đăng Nhập</a></div>
					
				</div>
				<div class="col">
					<div class="BangDN"><a href="DangKy.php" style="color: #000000">Đăng Ký</a></div>
				</div>
			</div>
			<form>
				  <div class="mb-3" style="margin-top: 20px">
					 <label for="validationCustom01" class="form-label"><b>Họ</b></label>
					 <input type="text" class="form-control" id="validationCustom01" placeholder="Nhập Họ" required>
					<div class="valid-feedback"></div>
				  </div>
				  <div class="mb-3" style="margin-top: 20px">
					 <label for="validationCustom02" class="form-label"><b>Tên</b></label>
					 <input type="text" class="form-control" id="validationCustom02" placeholder="Nhập Tên" required>
					<div class="valid-feedback"></div>
				  </div>
				<div class="mb-3" style="margin-top: 20px">
					 <label for="validationCustom03" class="form-label"><b>Số Điện Thoại</b></label>
					 <input type="text" class="form-control" id="validationCustom03" placeholder="Nhập Số điện thoại" required>
					<div class="valid-feedback"></div>
				  </div>
				<div class="mb-3" style="margin-top: 20px">
					 <label for="validationCustom04" class="form-label"><b>Email</b></label>
					 <input type="text" class="form-control" id="validationCustom04" placeholder="Nhập Email" required>
					<div class="valid-feedback"></div>
				  </div>
				<div class="mb-3" style="margin-top: 20px">
					 <label for="validationCustom05" class="form-label"><b>Mật Khẩu</b></label>
					 <input type="text" class="form-control" id="validationCustom05" placeholder="Nhập Mật khẩu" required>
					<div class="valid-feedback"></div>
				  </div>
				 
				  <button type="submit" class="btn" data-bs-toggle="button" style="background-color: #000000;color: #FFFFFF;width: 100%;margin-top: 20px">TẠO TÀI KHOẢN</button>
			</form>
