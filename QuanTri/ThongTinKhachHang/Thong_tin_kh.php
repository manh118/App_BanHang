...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/js/bootstrap.min.js" integrity="sha384-cVKIPhGWiC2Al4u+LWgxfKTRIcfu0JTxR+EQDz/bgldoEyl4H0zUF0QKbrJ0EcQF" crossorigin="anonymous"></script>
	...
	$sql_select_sanpham="Select * from `khachhang`";
...
{
	$stt_hang++;
	$id_khach[$stt_hang]=$row->id_khach;
	$hoten[$stt_hang]=$row->ho_ten;
	$sdt[$stt_hang]=$row->sdt;
	$email[$stt_hang]=$row->email;
	$gioithieu[$stt_hang]=$row->noidung;
	...
	<div class="QT_DienTT">
		<div class="container">
			<hr width="100%">
			<h2 style="text-align: center;margin-bottom: 20px">Thông tin khách hàng </h2>
			<table class="table table-bordered" style="border: 2px">
			<thead>
					<th width="100px">STT</th>
					<th width="200px">Họ và tên</th>
					<th width="300px">Số điện thoại</th>
			...
			<td><a href="Sua_ttkh.php?idkh=<?php echo $id_khach[$i] ?>" class="btn" style="color: #A9B45E" ><i class="fa-solid fa-pen-to-square"></i></a></td>
			<td><a href="Xoa_ttkh.php?idkh=<?php echo $id_khach[$i]?>" onClick = "return confirm('Bạn chắc chắn muốn xóa?')" class="btn" style="color: #CF0609"><i class="fa-solid fa-trash-can"></i></a></td>	
				</tbody>
				<?php
