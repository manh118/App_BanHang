...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/js/bootstrap.min.js" integrity="sha384-cVKIPhGWiC2Al4u+LWgxfKTRIcfu0JTxR+EQDz/bgldoEyl4H0zUF0QKbrJ0EcQF" crossorigin="anonymous"></script>
	...
	$sql_select_sanpham="Select * from `loai_sanpham` where id_loai_sanpham=$idsp";
	...
	<form name="frm_sanpham" method="post" action="Sua_loai_sp_luu.php?idsp=<?php echo $id_loaisp ?>" enctype="multipart/form-data">
<table class="table table-bordered" style="width: 700px;border: 2px">
				
	<tbody>
			<tr>
			  	<td colspan="2" align="center">THÊM LOẠI SẢN PHẨM</td>
			</tr>
					<tr>
			  <td width="100px">Tên loại sản phẩm</td>
			  <td width="100px"><input type="text" class="form-control" name="txt_ten_loai_sp" style="border-color: #000000"  value="<?php echo $tensp?>"></td>
			</tr>
			<tr>
			  <td>Ảnh</td>
			...
			<tr>
			  <td>Giới thiệu</td>
			  <td><input type="text" class="form-control" name="txt_gioithieu" style="border-color: #000000"  value="<?php echo $gioithieu?>"></td>
			</tr>		
