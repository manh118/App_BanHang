...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/js/bootstrap.min.js" integrity="sha384-cVKIPhGWiC2Al4u+LWgxfKTRIcfu0JTxR+EQDz/bgldoEyl4H0zUF0QKbrJ0EcQF" crossorigin="anonymous"></script>
	...
	<form name="frm_sanpham" method="post" action="Them_loai_sp_luu.php" enctype="multipart/form-data">
<table class="table table-bordered" style="width: 700px;border: 2px">
	...
	<tbody>
			<tr>
			  ...
			  <td width="100px"><input type="text" class="form-control" name="txt_ten_loai_sp" style="border-color: #000000"></td>
			</tr>
			<tr>
			  <td>Ảnh</td>
