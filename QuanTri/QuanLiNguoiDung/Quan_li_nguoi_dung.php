...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/js/bootstrap.min.js" integrity="sha384-cVKIPhGWiC2Al4u+LWgxfKTRIcfu0JTxR+EQDz/bgldoEyl4H0zUF0QKbrJ0EcQF" crossorigin="anonymous"></script>
	...
	$sql_select_sanpham="Select * from `user`";
...
{
	$stt_hang++;
	$id_tintuc[$stt_hang]=$row->id;
	$tieu_de[$stt_hang]=$row->email;
	$mk[$stt_hang]=$row->matkhau;
	...
	<div class="QT_Box_1">
		...
		<div class="QT_body">
			...
			<div class="QuanLi_taikhoan"><a href="Quan_li_nguoi_dung.php">QUẢN LÍ TÀI KHOẢN</a></div>
	...
	<div class="QT_DienTT">
		<div class="container">
			<hr width="100%">
			<h2 style="text-align: center">Danh Mục Tài Khoản </h2>
			<p><a href="Them_tt.php" class="btn btn-success">Thêm tài khoản +</a></p>
			...
			<td><?php echo $mk[$i]?></td>
			<td><a href="Sua_tt.php?idsp=<?php echo $id[$i] ?>" class="btn" style="color: #A9B45E;justify-content: center"><i class="fa-solid fa-pen-to-square"></i></a></td>
			<td><a href="Xoa_tt.php?idsp=<?php echo $id[$i]?>" onClick = "return confirm('Bạn chắc chắn muốn xóa?')" class="btn" style="color: #CF0609"><i class="fa-solid fa-trash-can"></i></a></td>	
				</tbody>
				<?php
