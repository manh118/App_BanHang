...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/js/bootstrap.min.js" integrity="sha384-cVKIPhGWiC2Al4u+LWgxfKTRIcfu0JTxR+EQDz/bgldoEyl4H0zUF0QKbrJ0EcQF" crossorigin="anonymous"></script>
	...
	$sql_select_sanpham="Select * from `sanpham`where id_loai_sanpham=$idsp ";
	...
	<div class="QT_DienTT">
		<div class="container">
			...
			<thead>
				...
				<tbody>
			<td><?php echo $i?></td>
			<td><?php echo layten("loai_sanpham","ten_loai_sp",$id_sanpham[$i],"id_loai_sanpham"); ?></td>
			...
			<td><a href="Sua.php?idsp=<?php echo $id_sanpham[$i] ?>" class="btn" style="color: #A9B45E" ><i class="fa-solid fa-pen-to-square"></i></a></td>
			<td><a href="Xoaa.php?idsp=<?php echo $id_sanpham[$i]?>" onClick = "return confirm('Bạn chắc chắn muốn xóa?')" class="btn" style="color: #CF0609"><i class="fa-solid fa-trash-can"></i></a></td>	
				</tbody>
				<?php
