...
<section class="MyHeader" style="background-color:#2E2E2E"> 
  ...
  <div class="container-fluid">
	...
	<section class="MyManicontent" style="height: 300px; align-content: center">		
		
		
	<h3 style="width:950px;margin-left: auto;margin-right: auto">Cảm ơn bạn đã mua hàng, chúng tôi sẽ liên lạc lại với bạn sớm nhất có thể</h3>
