  ...
  <div class="container-fluid">
	...
	<div class="DNTK">
			<div class="text-content">
				...
				<h4 class="text2">CHI TIẾT SẢN PHẨM</h4>
			</div>
...
<?php
		$sql_chitiet = "SELECT * FROM sanpham,loai_sanpham WHERE sanpham.id_loai_sanpham=loai_sanpham.id_loai_sanpham AND sanpham.id_sanpham='$_GET[id]' LIMIT 1";
...
?>
		...
		<div class="san_pham">
			<div class="img_sanpham">
				<img width="100%" src="img/<?php echo $row_chitiet['img_sp']?>">	
			</div>
			<form method="post" action="Gio_hang/Them_gio_hang.php?idsanpham=<?php echo $row_chitiet['id_sanpham']?>">
				<div class="chitiet_sanpham" style="width: 500px;text-align: justify">
					<h1 style="margin-bottom: 20px"><?php echo $row_chitiet['ten_sp']?></h1>
					<h4 style="color: red;margin-bottom: 20px"><?php echo number_format($row_chitiet['gia'],0,',','.').'đ'; ?></h4>
					<p class="chitiet_sanpham_loaisp">Loại sản phẩm: <b><?php echo $row_chitiet['ten_loai_sp']?></b></p>
					<p class="">Tình trạng: <b><?php echo $row_chitiet['ghichu']?></b></p>
					<p style="margin-top: 20px"><?php echo $row_chitiet['gioithieu']?></p>
					<p><input class="add_giohang" type="submit" name="themgiohang" value="Thêm vào giỏ hàng"></p>
